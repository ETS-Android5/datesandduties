...
public class Const {
    ...
    public static final String REM_EVENT = "http://coms-309-008.cs.iastate.edu:8080/account/removeEvent";
    ...
    public static final String EDIT_EVENT = "http://coms-309-008.cs.iastate.edu:8080/event/update";
